                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        ...
                        <select name="status" id="status" 
                            ...
                            <option value="contacted" {{ request('status') === 'contacted' ? 'selected' : '' }}>Contatado</option>
                            <option value="qualified" {{ request('status') === 'qualified' ? 'selected' : '' }}>Qualificado</option>
                    ...
                    <div>
                        ...
                        <select name="source" id="source" 
                            ...
                            <option value="social_media" {{ request('source') === 'social_media' ? 'selected' : '' }}>Redes Sociais</option>
                            <option value="referral" {{ request('source') === 'referral' ? 'selected' : '' }}>Indicação</option>
                            <option value="advertising" {{ request('source') === 'advertising' ? 'selected' : '' }}>Publicidade</option>
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div>
                                                <div class="text-sm font-medium text-gray-500">{{ $lead->name }}</div>
                                                @if($lead->company)
                                            ...
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                                @switch($lead->source)
                                                    ...
                                                    @case('referral')
                                                        ...
                                                        @break
                                                    @case('advertising')
                                                        <i class="ti ti-ad mr-1"></i> Publicidade
                                                        @break
                                                    @case('cold_call')
                                                        <i class="ti ti-phone-call mr-1"></i> Cold Call
                                                        @break
                                                    @case('event')
                                                        <i class="ti ti-calendar-event mr-1"></i> Evento
                                                        @break
                                                    @default
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @if($lead->probability)
                                            <div class="text-xs text-gray-400">{{ $lead->probability }}% probabilidade</div>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if($lead->user)
                ...
                <div class="text-center py-12">
                    ...
                    <p class="text-sm text-gray-400 mb-6">
                        @if(request()->hasAny(['search', 'status', 'source']))
                            ...
                            <a href="{{ route('admin.leads.index') }}" class="text-blue-600 hover:text-blue-700">limpar a busca</a>
                        @else
